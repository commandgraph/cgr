...
Write a plain-text file that reads like English, or use an automation agent like Codex or Claude Code on your behalf. The engine builds a dependency graph, parallelizes what it can, and executes over SSH or locally.
